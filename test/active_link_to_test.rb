...
class ActiveLinkToTest < Test::Unit::TestCase
  ...
  def test_active_link_to_with_wrap_tag
    ...
    assert_equal '<li class="wrapper active"><a href="/root" class="testing active">label</a></li>', link

    link = active_link_to('label', '/root', :wrap_tag => :li, :class => 'testing', wrap_tag_class: '')
    assert_equal '<li class="active"><a href="/root" class="testing active">label</a></li>', link
  end
