...
class ActiveLinkToTest < Test::Unit::TestCase
  ...
  def test_active_link_to_with_wrap_tag
    ...
    link = active_link_to('label', '/root', :wrap_tag => :li, :class => 'testing', wrap_tag_class: 'wrapper')
    assert_equal '<li class="wrapper active"><a class="testing active" href="/root">label</a></li>', link

    link = active_link_to('label', '/root', :wrap_tag => :li, :class => 'testing', wrap_tag_class: '')
    assert_equal '<li class="active"><a class="testing active" href="/root">label</a></li>', link
  end
  ...
  def test_no_empty_class_attribute
    ...
    link = active_link_to('label', '/other', :wrap_tag => :li, wrap_tag_class: '', class: 'link-class')
    assert_equal '<li><a class="link-class" href="/other">label</a></li>', link
  end
